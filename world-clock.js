  ...
  class WorldClock extends HTMLElement {
    ...
    render() {
      ...
      this.views=this.selected.map(city=>{
        ...
        grid.append(card);
        return {card,time:new Intl.DateTimeFormat(document.documentElement.lang || 'en-US',{timeZone:city[2],hour:'2-digit',minute:'2-digit',second:'2-digit',hour12:this.hour12}),date:new Intl.DateTimeFormat(document.documentElement.lang || 'en-US',{timeZone:city[2],weekday:'short',month:'short',day:'numeric'}),parts:new Intl.DateTimeFormat('en-GB',{timeZone:city[2],hour:'2-digit',minute:'2-digit',second:'2-digit',hourCycle:'h23',timeZoneName:'shortOffset'})};
      });
