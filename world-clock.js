(() => {
  ...
  class WorldClock extends HTMLElement {
    ...
    connectedCallback() { clearInterval(this.timer); this.render(); this.timer = setInterval(() => this.tick(),1000); }
